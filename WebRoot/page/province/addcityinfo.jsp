...
<body>
	<table class="right_top" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="right_top_center">当前位置：添加市局账号</td>
			...
			<td style="vertical-align:top; padding:3px;"><table width="500"
					...
					<tr>
						<th colspan="2"><table width="98%" border="0" cellspacing="0"
								cellpadding="0">
								<tr>
									<td height="27" align="left">&nbsp;&nbsp;添加市局账号</td>
									<td align="right">&nbsp;</td>
								</tr>
							</table></th>
					</tr>
					<tr class="trListOdd">
						...
						<td valign="top"><p>&nbsp;</p>
							<form id="addCityAccount" name="addCityAccount"
								onsubmit="return checkAll();" action="${pageContext.request.contextPath}/province/addcityinfo.do"
								method="post">
								<table cellspacing="0" cellpadding="0"
									style="text-align:left; width:98%; border:none;">
									<tr>
										<td width="50" height="30">&nbsp;</td>
										<td width="150">市局编码</td>
										<td width="320"><input type="text" name="prefixCode"
											value=600 readonly="readonly" size="1" /> <input type="text"
											name="code" value="" id="idCode" onblur="checkCode()" /><span
											id="errorCode" style="color:red;font-size:13px;"></span></td>
										<td></td>
									</tr>
									<tr>
										<td width="50" height="30">&nbsp;</td>
										<td width="150">市局名称</td>
									...
									<tr>
										...
										<td><input type="text" name="login.loginName" value=""
											...
											id="errorLoginName" style="color:red;font-size:13px;"></span>
										</td>
										<td></td>
									</tr>
									<tr>
										...
										<td><input type="text" name="password" value=""
											...
											id="errorPassword" style="color:red;font-size:13px;"></span>
										</td>
										<td><span id="errorCollege"
											style="color:red;font-size:13px;"></span></td>
									</tr>
									<tr>
										<td height="30">&nbsp;</td>
										<td>&nbsp;</td>
										<td><input type="submit" id="addCityAccount_0"
