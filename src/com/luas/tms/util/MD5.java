...
public class MD5 {
	...
	/*
	 * F, G, H ,I ��4��������MD5����.������ ����ʵ�ֳ���private���������ֱ�����ԭ��C�еġ�
	 */
	...
	public static void main(String args[]) {
		...
		MD5 m = new MD5();
		if (Array.getLength(args) == 0) { // ���û�в�����ִ��Ĭ�ϵ�Test

			System.out.println("MD5���Կ�ʼ��:");
			System.out.println("MD5:" + m.getMD5ofStr("js"));
			System.out.println("MD5(\"admin\"):" + m.getMD5ofStr("admin"));
			System.out.println("MD5(\"xiaojiji\"):" + m.getMD5ofStr("xiaojiji"));
			System.out
					.println("MD5(\"laosun\"):" + m.getMD5ofStr("laosun"));
